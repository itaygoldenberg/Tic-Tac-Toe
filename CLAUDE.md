...
- טקסטים קבועים: כותרת **"איקס עיגול"**, כפתורים **"התחל לשחק"** ו־**"משחק חדש"**, ניווט **בית / משחק / אודות**, מסך אודות: **"פותח על ידי איתי גולדנברג"** ומתחתיו **"איקס עיגול הוא משחק פשוט ומהנה המותאם לכל גיל"**. המשפט השני נוסף לבקשת המפתח, מעבר ל־PRD.
